      ...
      <div className="md:hero-content flex flex-col">
        ...
        <h4 className="md:w-full text-2x1 md:text-4xl text-center text-slate-300 my-2">
          ...
          <p className="text-slate-500 text-2x1 leading-relaxed">
            Build and deploy Solidity smart contracts on Solana with ease.
          </p>
        </h4>
        ...
        <div className="md:w-full text-center my-4">
          <Link
            href="https://github.com/dProgrammingUniversity/solidity-solana-full-stack-dapp-nextjs-boilerplate"
            target="_blank"
